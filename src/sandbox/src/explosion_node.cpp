...
ExplosionNode::ExplosionNode(std::string name, int start, int end, int factor)
: rclcpp::Node(name)
{
...
void ExplosionNode::sub_callback(
  std_msgs::msg::Int32::ConstSharedPtr msg, int start, int end,
  int id)
{
