...
int main(int argc, char * argv[])
{
  ...
  auto tmr1 = tmr1_node->create_wall_timer(
    50ms, [&](void) {
      do_work("Timer 1");
  ...
  auto sub1 = sub1_node->create_subscription<std_msgs::msg::Int32>(
    "topic_a", qos,
    [&](std_msgs::msg::Int32::ConstSharedPtr msg) {
      do_work("Sub 1");
    });
  auto sub2 = sub2_node->create_subscription<std_msgs::msg::Int32>(
    "topic_a", qos,
    [&](std_msgs::msg::Int32::ConstSharedPtr msg) {
      do_work("Sub 2");
    });
  ...
  auto tmr2 = tmr2_node->create_wall_timer(
    100ms, [&](void) {
      do_work("Timer 2");
      std_msgs::msg::Int32 msg;
  ...
  auto sub3 = sub3_node->create_subscription<std_msgs::msg::Int32>(
    "topic_b", qos,
    [&](std_msgs::msg::Int32::ConstSharedPtr msg) {
      do_work("Sub 3");
    });
  auto sub4 = sub4_node->create_subscription<std_msgs::msg::Int32>(
    "topic_b", qos,
    [&](std_msgs::msg::Int32::ConstSharedPtr msg) {
      do_work("Sub 4");
    });
